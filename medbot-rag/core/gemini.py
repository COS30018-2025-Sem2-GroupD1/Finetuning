...
def build_prompt(question: str, contexts: List[dict], locale: str | None = "en") -> Tuple[str, str]:
    #Prompt Stak
    system_text = (
        "You are MedBot, a clinical assistant for healthcare professionals. "
        "Be concise, evidence-informed, and guideline-aware. "
        "Provide differential considerations, red flags, and management options with appropriate caveats. "
        "Do NOT replace clinical judgment or local protocols; note limitations clearly.\n\n"
